...
1. **Python Basics:**
   Covers essential topics such as syntax, variables, data types, loops, conditional statements, and functions.

2. **Object-Oriented Programming (OOP):**
   Dive into advanced concepts including classes, objects, inheritance, polymorphism, and encapsulation.

## Direct Downloads

You can access or download specific parts of the coursework using the links below:

- [Download Python Basics Files](https://github.com/yossefhaytham/Python_Learning/tree/main/Basics_From_Scratch)
- [Download OOP Files](https://github.com/yossefhaytham/Python_Learning/tree/main/OOP)
